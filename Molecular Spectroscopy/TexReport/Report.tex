...
% Refrence to papers
on the subject was consulted. The LM cigar has the widest range of wavenumbers, as such, the LM cigar smoke's IR spectrum is shown in Figures \ref{fig:DiverseLM} and \ref{fig:COCO2LM}. Other IR spectra are quite similar, however, NEXT and Marlborro's smoke IR spectra are only between $1999\text{cm}^{-1}$ and $2400\text{cm}^{-1}$ (See nispachim).
% lo zocher ma hamila
\begin{figure}
