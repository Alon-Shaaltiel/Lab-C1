...
\begin{tabular}{ |p{2cm}|p{2cm}|p{2cm}|  }
 \hline
 \multicolumn{3}{|c|}{\thead{Fit Parameters and \\Statistical Values of Ethanol Calibration Graph}} \\ \hline
 Parameter& Value &Error (Relative Error)\\ \hline
 $a_{0}$[$1$]    &$11.7$    &$9.3$($79\%$) \\
...
\begin{equation}
\label{eq:CO2ratio}
S=\frac{Absorbance_{Exhaled}}{Absorbance_{Outside}}=61\pm24\ \text{[No Units]} % Perhaps add \frac{Absorbance_{Exhaled}}{Absorbance_{Outside}}. just writing S is a bit unclear RE:fixed
\end{equation}
$S$
...
\begin{table}[H]
    \begin{tabular}{ |p{2.8cm}||p{2.8cm}|p{2.8cm}|  }
     ...
     \hline
     \multicolumn{3}{|c|}{\thead{Fit Parameters and Statistical Values\\ of the CO absorption lines $3^{rd}$ polynomial fit}} \\
     \hline
     Parameter& Value(\%) & Error (Relative Error) \\ \hline
